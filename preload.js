...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  writeAudioTags: (filePath, tags) =>
    ipcRenderer.invoke("write-audio-tags", filePath, tags),
  ...
  renameFile: (filePath, desiredBaseName) =>
    ipcRenderer.invoke("rename-file", filePath, desiredBaseName),
  ...
  getDefaultConvertOutput: () =>
    ipcRenderer.invoke("get-default-convert-output"),
  ...
  onFFmpegInstallProgress: (callback) => {
    ipcRenderer.on("ffmpeg-install-progress", (event, payload) =>
      callback(payload),
    );
  },
