...
const I18N = {
  en: {
    ...
    "empty.noSongs":
      "No songs here yet. Add some music to get started — go to the Folders tab and add your favorite music folder to get started.",
    ...
    "empty.noListeningHistory": "No listening history yet.",
    "empty.noPlaylistsForAdd":
      "You don't have any playlists yet. Create one from the Playlists tab first.",
    "empty.noLibraryForAddMusic":
      "No songs in your library yet. Import some from the Songs or Folders tab first.",
    "empty.noAddMusicResults": "No songs match your search.",
    "empty.nothingPlayingInfo":
      "Nothing is playing yet. Play a song to see its details here.",
    "empty.nothingPlayingEdit":
      "Nothing is playing yet. Play a song first, then use the ☰ menu to edit it.",
    "empty.nothingPlayingSync":
      "Nothing is playing yet. Play a song first, then use the ☰ menu to sync its lyrics.",

    "lyrics.loading": "Loading lyrics…",
    "lyrics.notFoundShort": "No lyrics found for this track.",
    "lyrics.notFound":
      "No lyrics found for this track, so there's nothing to sync.",
    "lyrics.notTimeSynced":
      "This track's lyrics aren't time-synced, so there's nothing to offset.",
    ...
    "playlist.exportedWithSkipped":
      "Exported ({count} song(s) without a saved file location were skipped).",
    ...
    "confirm.deleteNamedWithLabel":
      'Delete "{name}"{label}? This can\'t be undone.',
    "confirm.deleteCountPlaylists":
      "Delete {label}? This can't be undone. The songs inside will stay in your library.",
    ...
    "edit.autoTagFoundFingerprint":
      "Match found from the audio itself — review below, then save.",
    "edit.autoTagFoundMusicbrainz":
      "Match found from title/artist search — review below, then save.",
    ...
    "edit.savedRenamedAndUpdated":
      "Saved — the file on disk was renamed and updated too.",
    "edit.savedTagsButNotRenamed":
      "Saved — tags updated on disk, but the file couldn't be renamed: {reason}",
    "edit.savedToLibraryOnly": "Saved to your library. {reason}",
    "edit.savedButNotRenamed":
      "Saved to your library, but the file couldn't be renamed: {reason}",
    "edit.savedButNoCoverArtSupport":
      "Saved — tags updated on disk, but this file format can't hold embedded cover art.",
    "edit.fileNotChanged": "The file on disk wasn't changed.",
    "edit.couldntRenameGeneric": "Couldn't rename the file on disk.",
    "edit.fileWriteFailed":
      "The file on disk wasn't updated. {reason} Nothing has been saved yet.",
    ...
    "backup.note":
      "Saves your playlists, favorites, lyrics, and settings to a file — handy before reinstalling or moving to a new PC. Songs are referenced by their saved file location, not copied into the backup.",
    "backup.exportBtn": "Export Backup",
    "backup.importBtn": "Import Backup",
    "backup.exporting": "Saving backup…",
    "backup.exported": "Backup saved.",
    "backup.exportedWithSkipped":
      "Backup saved ({count} song(s) without a saved file location were skipped).",
    "backup.exportFailed": "Couldn't save backup: {reason}",
    "backup.importConfirm":
      "Import this backup? Matching playlists/songs will be overwritten — nothing else is deleted.",
    ...
    "sleep.note":
      "Pauses playback once the time is up. Doesn't touch repeat, shuffle, or your queue — everything picks up right where it left off if you hit play again.",
    ...
    "audio.equalizerNote":
      "A 10-band graphic EQ. Turn it on, then use a preset or drag the bands yourself.",
    "audio.eqFlat": "Flat",
    ...
    "settings.blur": "Blur",
    "settings.playerBgNote":
      "Shown behind the cover art on the now-playing panel. Stored on this device only.",
    ...
    "updates.promptBody":
      "Version {version} is ready to download. Download it now?",
    "updates.later": "Later",
    ...
    "about.tagline":
      "PLAYNCK is a fast, no-frills music player for your local library — folders in, playback, tags, cover art and time-synced lyrics out. No accounts, no streaming, no ads: just the songs already on your computer.",
    "about.buildVersion": "Build version",
    "about.communityText":
      "Got a bug, an idea, or just want to hang out with other people using PLAYNCK? Come say hi on Telegram — it's where updates get announced first, feature requests get discussed, and folks help each other out.",
    "about.telegramBtn": "Join the Telegram group",
    "about.supportTitle": "Support Playnck ❤️",
    "about.supportText":
      "Enjoying Playnck? If you'd like to support the project and its future development, you can send a small donation through Binance Pay.",
    ...
    "convert.ffmpegRequiredNote":
      "The Convert tab uses FFmpeg to do the actual audio conversion. It's free and open-source, and only needs to be installed once.",
    ...
    "convert.installManually":
      "You can also install FFmpeg yourself from ffmpeg.org, then reopen this tab.",
    ...
    "convert.queueEmpty":
      "No files added yet — drag audio files in, or use Browse Files / Add Folder above.",
    ...
    "convert.flacCompressionNote":
      "Higher = smaller file, slower to encode. Doesn't affect audio quality — FLAC is always lossless.",
    "convert.bitDepth": "Bit Depth",
    "convert.losslessNote":
      "Lossless — nothing to lose, so there's no quality setting.",
  ...
  fr: {
    ...
    "empty.noSongs":
      "Aucun titre ici pour le moment. Ajoutez de la musique pour commencer — allez dans l'onglet Dossiers et ajoutez votre dossier de musique préféré.",
    ...
    "empty.noListeningHistory": "Aucun historique d'écoute pour le moment.",
    "empty.noPlaylistsForAdd":
      "Vous n'avez pas encore de playlist. Créez-en une depuis l'onglet Playlists.",
    "empty.noLibraryForAddMusic":
      "Aucun titre dans votre bibliothèque. Importez-en depuis l'onglet Titres ou Dossiers.",
    "empty.noAddMusicResults": "Aucun titre ne correspond à votre recherche.",
    "empty.nothingPlayingInfo":
      "Rien n'est en cours de lecture. Lancez un titre pour voir ses informations ici.",
    "empty.nothingPlayingEdit":
      "Rien n'est en cours de lecture. Lancez d'abord un titre, puis utilisez le menu ☰ pour le modifier.",
    "empty.nothingPlayingSync":
      "Rien n'est en cours de lecture. Lancez d'abord un titre, puis utilisez le menu ☰ pour synchroniser ses paroles.",

    "lyrics.loading": "Chargement des paroles…",
    "lyrics.notFoundShort": "Aucune parole trouvée pour ce titre.",
    "lyrics.notFound":
      "Aucune parole trouvée pour ce titre, il n'y a donc rien à synchroniser.",
    "lyrics.notTimeSynced":
      "Les paroles de ce titre ne sont pas synchronisées, il n'y a donc rien à décaler.",
    "lyrics.syncOffsetAriaLabel":
      "Décalage de synchronisation des paroles en millisecondes",
    ...
    "playlist.exportUnavailable":
      "L'exportation des playlists nécessite l'application de bureau.",
    "playlist.exportedWithSkipped":
      "Exporté ({count} morceau(x) sans emplacement de fichier enregistré ont été ignorés).",
    ...
    "confirm.forgetNamed":
      "Oublier « {name} »{label} ? Cette action est irréversible.",
    "confirm.deleteNamedWithLabel":
      "Supprimer « {name} »{label} ? Cette action est irréversible.",
    "confirm.deleteCountPlaylists":
      "Supprimer {label} ? Cette action est irréversible. Les titres qu'elles contiennent resteront dans votre bibliothèque.",
    "confirm.deleteCountSongs":
    ...
    "edit.autoTagFoundFingerprint":
      "Correspondance trouvée à partir de l'audio — vérifiez puis enregistrez.",
    "edit.autoTagFoundMusicbrainz":
      "Correspondance trouvée par recherche titre/artiste — vérifiez puis enregistrez.",
    ...
    "edit.savedRenamedAndUpdated":
      "Enregistré — le fichier sur le disque a aussi été renommé et mis à jour.",
    "edit.savedTagsButNotRenamed":
      "Enregistré — les tags ont été mis à jour sur le disque, mais le fichier n'a pas pu être renommé : {reason}",
    "edit.savedToLibraryOnly": "Enregistré dans votre bibliothèque. {reason}",
    "edit.savedButNotRenamed":
      "Enregistré dans votre bibliothèque, mais le fichier n'a pas pu être renommé : {reason}",
    "edit.savedButNoCoverArtSupport":
      "Enregistré — les tags ont été mis à jour sur le disque, mais ce format de fichier ne peut pas contenir de pochette intégrée.",
    "edit.fileNotChanged": "Le fichier sur le disque n'a pas été modifié.",
    "edit.couldntRenameGeneric":
      "Impossible de renommer le fichier sur le disque.",
    "edit.fileWriteFailed":
      "Le fichier sur le disque n'a pas été mis à jour. {reason} Rien n'a encore été enregistré.",
    ...
    "backup.desktopOnly":
      "La sauvegarde et la restauration nécessitent l'application de bureau.",
    "backup.note":
      "Enregistre vos playlists, favoris, paroles et paramètres dans un fichier — pratique avant une réinstallation ou un changement de PC. Les morceaux sont référencés par leur emplacement de fichier enregistré, pas copiés dans la sauvegarde.",
    ...
    "backup.exportedWithSkipped":
      "Sauvegarde enregistrée ({count} morceau(x) sans emplacement de fichier enregistré ont été ignorés).",
    "backup.exportFailed": "Impossible d'enregistrer la sauvegarde : {reason}",
    "backup.importConfirm":
      "Importer cette sauvegarde ? Les playlists/morceaux correspondants seront remplacés — rien d'autre n'est supprimé.",
    "backup.importing": "Restauration de la sauvegarde…",
    "backup.imported":
      "{restored} morceau(x) restauré(s) ({skipped} ignoré(s)).",
    "backup.importFailed": "Impossible d'importer la sauvegarde : {reason}",
    "backup.invalidFile":
      "Ce fichier ne semble pas être une sauvegarde Playnck.",
    "side.sleepTimer": "Minuterie de veille",
    "sleep.title": "Minuterie de veille",
    "sleep.off":
      "Désactivée — la lecture ne se mettra pas en pause automatiquement.",
    "sleep.activeStatus": "S'arrête dans environ {minutes} min.",
    "sleep.presetMinutes": "{minutes} min",
    "sleep.turnOff": "Désactiver",
    "sleep.note":
      "Met la lecture en pause une fois le temps écoulé. N'affecte ni la répétition, ni la lecture aléatoire, ni votre file d'attente — tout reprend exactement là où c'était si vous relancez la lecture.",
    ...
    "settings.themeNote":
      "Les changements s'appliquent immédiatement et durent le temps de cette session.",
    "settings.audioPlaceholder":
      "Les paramètres audio seront bientôt disponibles ici.",
    "audio.equalizer": "Égaliseur",
    "audio.equalizerNote":
      "Un égaliseur graphique à 10 bandes. Activez-le, puis utilisez un préréglage ou ajustez les bandes vous-même.",
    "audio.eqFlat": "Plat",
    ...
    "settings.blur": "Flou",
    "settings.playerBgNote":
      "Affiché derrière la pochette dans le panneau de lecture. Stocké uniquement sur cet appareil.",
    "settings.noImage": "Aucune image",

    "updates.checking": "Recherche de mises à jour…",
    "updates.foundDownloading":
      "Mise à jour trouvée (v{version}) — prête à télécharger",
    "updates.downloading": "Téléchargement de la mise à jour…",
    "updates.readyRestart":
      "Mise à jour prête (v{version}) — redémarrez pour l'installer",
    ...
    "updates.onlyDesktop":
      "Les mises à jour ne sont disponibles que dans l'application de bureau installée.",
    "updates.promptTitle": "Mise à jour disponible",
    "updates.promptBody":
      "La version {version} est prête à être téléchargée. La télécharger maintenant ?",
    ...
    "language.note":
      "Votre choix de langue est enregistré uniquement sur cet appareil.",

    "about.tagline":
      "PLAYNCK est un lecteur de musique rapide et sans fioritures pour votre bibliothèque locale — importez vos dossiers, et profitez de la lecture, des tags, des pochettes et des paroles synchronisées. Pas de compte, pas de streaming, pas de publicité : juste les titres déjà sur votre ordinateur.",
    "about.buildVersion": "Version",
    "about.communityText":
      "Un bug, une idée, ou juste envie de discuter avec d'autres personnes qui utilisent PLAYNCK ? Venez faire un tour sur Telegram — c'est là que les mises à jour sont annoncées en premier, que les suggestions sont discutées, et où tout le monde s'entraide.",
    "about.telegramBtn": "Rejoindre le groupe Telegram",
    "about.supportTitle": "Soutenir Playnck ❤️",
    "about.supportText":
      "Vous aimez Playnck ? Si vous souhaitez soutenir le projet et son développement futur, vous pouvez envoyer un petit don via Binance Pay.",
...
function tr(key, vars) {
  ...
  let str =
    dict[key] != null ? dict[key] : I18N.en[key] != null ? I18N.en[key] : key;
  if (vars) {
...
function pluralWord(key) {
  return pluralForms(key)[1];
}

function themeBgLabel(key) {
  return tr("theme.bg." + key);
}
function themeAccentLabel(key) {
  return tr("theme.accent." + key);
}
...
function applyI18n() {
  ...
  if (selectToggleEl)
    selectToggleEl.title =
      tr("header.selectPrefix") +
      pluralWord(SELECT_TYPE_PLURAL_KEY[state.selectType] || "song");
  ...
  if (playBtnEl) {
    ...
    playBtnEl.setAttribute(
      "aria-label",
      playing ? tr("player.pause") : tr("player.play"),
    );
  }
}
